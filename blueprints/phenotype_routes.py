...
parser.add_argument('indel', type=str, default="both", help='Type of variants (e.g., indel, snp, both)')
...
class PhenoFilter(Resource):
    ...
    def get(self, phenocode1, phenocode2=None):
        ...
        chosen_variants2 = extract_variants(phenocode2, min_maf, max_maf, indel) if phenocode2 else None
...
@api.route('/phenotypes/<phenocode>/region/<region_code>')
